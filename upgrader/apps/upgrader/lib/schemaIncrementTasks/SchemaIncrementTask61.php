...
class SchemaIncrementTask61 extends SchemaIncrementTask {
    ...
    public function loadSql() {
        ...
        $sql[] = "CREATE TABLE `ohrm_performance_objective` ( 
                `id` int(11) NOT NULL AUTO_INCREMENT, 
                ...
                CONSTRAINT `ohrm_performance_objective_fk1` FOREIGN KEY (`emp_number`) REFERENCES `hs_hr_employee` (`emp_number`) ON DELETE CASCADE ON UPDATE CASCADE, 
                CONSTRAINT `ohrm_performance_objective_fk2` FOREIGN KEY (`added_by`) REFERENCES `hs_hr_employee` (`emp_number`) ON DELETE CASCADE ON UPDATE CASCADE 
              ) ENGINE=InnoDB  DEFAULT CHARSET=utf8;";

        $sql[] = "CREATE TABLE `ohrm_performance_objective_log` ( 
                `id` int(11) NOT NULL AUTO_INCREMENT, 
                ...
                CONSTRAINT `fk_ohrm_performance_objective_log_1` FOREIGN KEY (`user_id`) REFERENCES `ohrm_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE, 
                ...
                CONSTRAINT `ohrm_performance_objective_log_fk2` FOREIGN KEY (`reviewer_id`) REFERENCES `hs_hr_employee` (`emp_number`) ON DELETE CASCADE ON UPDATE CASCADE 
              ) ENGINE=InnoDB DEFAULT CHARSET=utf8;";

        $sql[] = "CREATE TABLE `ohrm_performance_objective_reviewer` ( 
                `id` int(11) NOT NULL AUTO_INCREMENT, 
                ...
                CONSTRAINT `ohrm_performance_objective_reviewer_fk2` FOREIGN KEY (`reviewer_id`) REFERENCES `hs_hr_employee` (`emp_number`) ON DELETE CASCADE ON UPDATE CASCADE 
              ) ENGINE=InnoDB DEFAULT CHARSET=utf8;";
...
( 'Manage_Objectives', @performance_module_id, 'addPerformanceObjective');";
        $sql[] = "SET @manage_performance_objectives_screen_id :=  (SELECT LAST_INSERT_ID());";

        $sql[] = "SET @performance_menu_id:= (SELECT id FROM ohrm_menu_item where menu_title = 'Performance');";
        $sql[] = "INSERT INTO ohrm_menu_item (`menu_title`, `screen_id`, `parent_id`, `level`, `order_hint`, `url_extras`, `status`) VALUES
('Objectives', @manage_performance_objectives_screen_id, @ConfigureKPI_screen_id, 3, 200, NULL, 1);";
...
( 'Employee_Objectives', @performance_module_id, 'viewEmployeePerformanceObjectiveList');";
        $sql[] = "SET @employee_objectives_screen_id :=  (SELECT LAST_INSERT_ID());";
        $sql[] = "INSERT INTO ohrm_menu_item (`menu_title`, `screen_id`, `parent_id`, `level`, `order_hint`, `url_extras`, `status`) VALUES
('Employee Objectives', @employee_objectives_screen_id, @performance_menu_id, 2, 800, NULL, 1);";
...
( 'My_Objectives', @performance_module_id, 'viewMyPerformanceObjectiveList');";
        $sql[] = "SET @my_objectives_screen_id :=  (SELECT LAST_INSERT_ID());";
...
( 'Employee_Objective_Logs', @performance_module_id, 'addPerformanceObjectiveLog');";
        $sql[] = "SET @employee_objective_logs_screen_id :=  (SELECT LAST_INSERT_ID());";
