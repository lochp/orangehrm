...
class SchemaIncrementTask62 extends SchemaIncrementTask {
    ...
    public function loadSql() {
        ...
        $sql[] = 'UPDATE `ohrm_screen` SET `module_id` = @performance_module_id WHERE `name` = \'Manage_Objectives\' AND `action_url` = \'addPerformanceObjective\'';
        
        $sql[] = 'UPDATE `ohrm_screen` SET `module_id` = @performance_module_id WHERE `name` = \'Employee_Objectives\' AND `action_url` = \'viewEmployeePerformanceObjectiveList\'';
        
        $sql[] = 'UPDATE `ohrm_screen` SET `module_id` = @performance_module_id WHERE `name` = \'My_Objectives\' AND `action_url` = \'viewMyPerformanceObjectiveList\'';
        
        $sql[] = 'UPDATE `ohrm_screen` SET `module_id` = @performance_module_id WHERE `name` = \'Employee_Objective_Logs\' AND `action_url` = \'addPerformanceObjectiveLog\'';
