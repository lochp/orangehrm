 ...
 * @method date                getOneTimePerDay()   Returns the current record's "oneTimePerDay" value
 ...
 * @method EmailNotification   setOneTimePerDay()   Sets the current record's "oneTimePerDay" value
...
abstract class BaseEmailNotification extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('one_time_per_day as oneTimePerDay', 'string', null, array(
            'type' => 'string',
            'length' => 250,
            ));
    }
