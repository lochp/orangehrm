 ...
 * @method string              getCustomerMail()    Returns the current record's "customerMail" value
 ...
 * @method Project             setCustomerMail()    Sets the current record's "customerMail" value
...
abstract class BaseProject extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('customer_mail as customerMail','string', 250, array(
            'type' => 'string', 
            'length' => 250,
        ));
    }
