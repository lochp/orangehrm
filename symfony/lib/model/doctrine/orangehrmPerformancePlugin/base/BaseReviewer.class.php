 ...
 * @method clob                getObjectives()      Returns the current record's "objectives" value
 ...
 * @method Reviewer            setObjectives()      Sets the current record's "objectives" value 
 *
 * @package    orangehrm
...
abstract class BaseReviewer extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
		...
		$this->hasColumn('objectives as objectives', 'clob', 65532, array(
             'type' => 'clob',
             'length' => 65532,
             ));
    }
