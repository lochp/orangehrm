 ...
 * @property Doctrine_Collection $PerformanceObjective
 ...
 * @method Doctrine_Collection       getPerformanceObjective()           Returns the current record's "PerformanceObjective" collection
 ...
 * @method Employee                  setPerformanceObjective()           Sets the current record's "PerformanceObjective" collection
 * @method Employee                  setPerformanceObjectiveLog()      Sets the current record's "PerformanceObjectiveLog" collection
 * @method Employee                  setPerformanceObjectiveReviewer() Sets the current record's "PerformanceObjectiveReviewer" collection
...
abstract class BaseEmployee extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('PerformanceObjective', array(
             'local' => 'emp_number',
             'foreign' => 'emp_number'));
