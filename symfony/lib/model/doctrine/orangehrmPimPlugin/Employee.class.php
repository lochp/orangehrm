...
//        return false;
    ...
    public function getOperationalCountry(){
        ...
        if( $employeeLocations[0] instanceof Location){
            ...
            $operCtnDao = new OperationalCountryDao();
            $cnt = $employeeLocations[0]->getCountry();
            if (isset($cnt) && isset($cnt->cou_code)){
            	$operationalCountry = $operCtnDao->getOperationalCountryForCountryCode($cnt->cou_code);
            }
            return $operationalCountry;
        }
        return null;
