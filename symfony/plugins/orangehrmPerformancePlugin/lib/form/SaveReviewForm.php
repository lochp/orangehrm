...
class SaveReviewForm extends BasePefromanceSearchForm {
    ...
    protected function getFormLabels() {
        ...
        $labels = array(
            ...
            'workPeriodStartDate' => __("Review Period Start Date") . $requiredMarker,
            'workPeriodEndDate' => __("Review Period End Date") . $requiredMarker,
            'dueDate' => __("Review Date") . $requiredMarker
        );
        return $labels;
    }
