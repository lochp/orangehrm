...
class ProjectForm extends BaseForm {
    ...
    private function setDefaultValues($projectId) {
        ...
        $this->setDefault('customerMail',$project->getCustomerMail()); //Marc Modif Mail for Customer
    ...
    protected function saveProject($project) {
        ...
        $project->setCustomerMail($this->getValue('customerMail')); //Marc Modif Mail for customer reports
    ...
    public function getProjectWidgets() {
        ...
        $widgets['customerMail'] = new sfWidgetFormInputText(); //Marc Modif mail for customer reports
    ...
    public function getProjectValidators() {
        ...
        $validators['customerMail'] = new sfValidatorString(array('required' => false, 'max_length' => 250, 'trim' => true)); //Marc Modif mail for customer reports
