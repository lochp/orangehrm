...
class OperationalCountryService extends BaseService {
    ...
    public function getOperationalCountryForEmployee($empNumber) {
        return $this->getOperationalCountryDao()->getOperationalCountryForEmployee($empNumber);
    }

    /**
     * @uses Loc
     * @param unknown $couCode
     */
    public function getOperationalCountryForCountryCode($couCode){
    	return $this->getOperationalCountryDao()->getOperationalCountryForCountryCode($couCode);
    }
}
