...
class EmailNotificationService extends BaseService {
    ...
    //Marc Modif
    //Methods set and get for the field OneTimePerDay
    public function getOneTimePerDay($id){
        return $this->emailNotificationDao->getOneTimePerDay($id);
    }

    public function setOneTimePerDay($date,$name){
        $this->emailNotificationDao->setOneTimePerDay($date,$name);
    }
}
