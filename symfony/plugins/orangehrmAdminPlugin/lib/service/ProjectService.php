...
class ProjectService extends BaseService {
    ...
    //Marc Modif get customerMail for reports
	public function getCustomerMailByProjectId($projectId){
		return $this->projectDao->getCustomerMailByProjectId($projectId);
	}
    /**
