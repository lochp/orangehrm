        ...
        <form name="frmAddProject" id="frmAddProject" method="post" action="<?php echo url_for('admin/saveProject'); ?>" >
            ...
            <fieldset>
                ...
                <ol>
                    ...
                    <?php//Marc Modif customer mail for reports ?>
                    
                    <li>
                        <?php echo $form['customerMail']->renderLabel(__('Customer Email Address')); ?>
                        <?php echo $form['customerMail']->render(array("class" => "formInputCustomerMail", "maxlength" => 250)); ?>
                    </li>
