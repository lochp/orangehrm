...
class saveJobTitleAction extends baseAdminAction {
    ...
    public function execute($request) {
        ...
        $jobTitleId = $request->getParameter('jobTitleId'); // ? (int) $request->getParameter('jobTitleId') : null;
        ...
        if ($request->isMethod('post')) {
            if ($this->jobTitlePermissions->canCreate() || $this->jobTitlePermissions->canUpdate()){ //|| $sf_user->getAttribute('auth.isAdmin') =="Yes") {
            ...
            if ((empty($jobTitleId) && !$this->jobTitlePermissions->canCreate()) 
                    || (!empty($jobTitleId) && !$this->jobTitlePermissions->canRead())){ //  || $sf_user->getAttribute('auth.isAdmin') != "Yes") {
