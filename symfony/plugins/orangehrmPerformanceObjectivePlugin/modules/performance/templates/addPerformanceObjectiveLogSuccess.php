<?php use_javascript('../orangehrmPerformanceObjectivePlugin/js/addPerformanceObjectiveLogSuccess'); ?>

<div id="performanceObjectiveLog" class="box">

    <div class="head">
        <h1 id="formHeading">
            <?php echo __('Manage Performance Objective Log'); ?>
        </h1>
    </div>
    ...
    <div class="inner">
        ...
        <form action="#" id="frmAddperformanceObjectiveLog" name="frmAddperformanceObjectiveLog" class="content_inner" method="post">
...
<div class="modal hide" id="commentDialog">
  <div class="modal-header">
    ...
    <h3><?php echo __('Performance Objective Log Comment'); ?></h3>
  </div>
  <div class="modal-body">
    <p>
    <form action="updateComment" method="post" id="frmCommentSave">
        <input type="hidden" id="objectiveLogId" />
        <input type="hidden" id="leaveOrRequest" />
        <textarea name="objectiveLogComment" id="objectiveLogComment" cols="40" rows="10" class="commentTextArea"></textarea>
        <br class="clear" />
