...
<div class="modal hide" id="multiperiod_balance">
  ...
  <div class="modal-footer">
    ...
    function handlePartialDayChange(showMultiDay) {
        ...
        if (!showMultiDay || partialDay === '') {
        ...
        } else if (partialDay === 'all' ){
            $('#applyleave_firstDuration_duration').parent('li').show();
            $('#applyleave_secondDuration_duration').parent('li').hide();
			
        	
        }
        else if (partialDay === 'start') {
            $('#applyleave_firstDuration_duration').parent('li').show();
            $('#applyleave_secondDuration_duration').parent('li').hide();

			   $("#applyleave_firstDuration_ampm").empty();
			   $("#applyleave_firstDuration_ampm").append($("<option></option>").attr("value","PM").attr("selected","selected").text("Afternoon"));
			...
			$("#applyleave_secondDuration_ampm").val('AM');
			
			$("#applyleave_secondDuration_ampm").empty();
			   $("#applyleave_secondDuration_ampm").append($("<option></option>").attr("value","AM").attr("selected","selected").text("Morning"));
