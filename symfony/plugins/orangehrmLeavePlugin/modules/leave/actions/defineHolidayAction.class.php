            ...
            if ($this->holidayPermissions->canCreate() || $this->holidayPermissions->canUpdate()) {
                ...
                if ($this->form->isValid()) {
                    ...
                    if (!$allowToAdd && !is_null($date)) {
                        ...
                        /**
                         * @author Loc
                         * Set operational country for holiday
                         */
                        try{
                        	$operationalCountry = $this->getOperationalCountryService()->getOperationalCountryForCountryCode($post['country']);
                        	if (!is_null($post['country']) && strlen($post['country']) > 0){
                        		$holidayObject->setOperationalCountry($operationalCountry[0]);
                        	}else{
                        		$holidayObject->setOperationalCountry(null);
                        	}
                        }catch(Exception $e){
                        	 
                        }
                        /**
                         * End set operational country for holiday
                         */
