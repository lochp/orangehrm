   ...
   /**
    ...
    public function execute( $request ){
        ...
        foreach ($holidayList as $holiday) {
            ...
            $couCode = $holiday->getOperationalCountry()->getCountryCode();
            $dateList[] = array(date('Y',  strtotime($holiday->getdate())), date('m',  strtotime($holiday->getdate())), 
            					date('d',  strtotime($holiday->getdate())),$htype, $holiday->getRecurring(),
            					$couCode
            ) ;
        }
