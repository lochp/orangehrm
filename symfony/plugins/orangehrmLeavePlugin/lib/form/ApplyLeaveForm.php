...
class ApplyLeaveForm extends sfForm {
    ...
    public function createLeaveObjectListForAppliedRange() {
        ...
        $operationalCountry = $employee->getOperationalCountry();
        ...
        for ($timeStamp = $from; $timeStamp <= $to; $timeStamp = $this->incDate($timeStamp)) {
            ...
            $isHoliday = $this->isHoliday($leaveDate,$operationalCountry);
            $isHalfday = $this->isHalfDay($leaveDate);
            $isHalfDayHoliday = $this->isHalfdayHoliday($leaveDate,$operationalCountry);
     ...
     * @return boolean
     */
    public function isHoliday($day,OperationalCountry $operationalCountry) {
        $holidayService = new HolidayService();
        return $holidayService->isHoliday($day,$operationalCountry);
    }
     ...
     * @return boolean
     */
    public function isHalfdayHoliday($day,$operationalCountry) {
        $holidayService = new HolidayService();
        return $holidayService->isHalfdayHoliday($day,$operationalCountry);
    }
