...
class HolidayForm extends sfForm {
    ...
    public function setDefaultValues($holidayId) {
        ...
        if ($holidayObject instanceof Holiday) {
             ...
             * Loc add country
             */
            if (!is_null($holidayObject->getOperationalCountryId())){
            	$this->setDefault('country', $holidayObject->getOperationalCountry()->getCountryCode());
            }
        }
    }
    ...
    protected function getFormWidgets() {
         ...
         * Loc add country
         */
        $widgets['country'] = new sfWidgetFormSelect(array('choices' => $this->getCountryList()));
        return $widgets;
    }
    ...
    protected function getFormValidators() {
         ...
         * Loc add country
         */
        $validators['country'] = new sfValidatorChoice(array('required' => true, 'choices' => array_keys($this->getCountryListWithoutDefault())));
        /**
         * Loc end
         */
        return $validators;
    ...
    protected function getFormLabels() {
         ...
         * Loc add country
         */
        $labels['country'] = __('Working Country') . $requiredLabel;
        return $labels;
    }
