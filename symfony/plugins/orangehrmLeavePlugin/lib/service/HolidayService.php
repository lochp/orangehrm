...
class HolidayService extends BaseService {
     ...
     * @param date $day
     * @return boolean
     * Loc add $operationalCountry
     */
    public function isHoliday($day, OperationalCountry $operationalCountry = null) {

//         $holiday = $this->getHolidayDao()->readHolidayByDate($day); // Loc Edit like below line
    	$holiday = $this->getHolidayDao()->readHolidayByDate($day, $operationalCountry);
