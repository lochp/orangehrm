...
class BasicWorkSchedule implements WorkScheduleInterface {
    ...
    public function isHoliday($day, OperationalCountry $operationalCountry = null) {
//         return $this->getHolidayService()->isHoliday($day);// Loc edit like below line
    	return $this->getHolidayService()->isHoliday($day, $operationalCountry);
    }
    
    public function isHalfdayHoliday($day, OperationalCountry $operationalCountry = null) {
        return $this->getHolidayService()->isHalfdayHoliday($day,$operationalCountry);
    }
