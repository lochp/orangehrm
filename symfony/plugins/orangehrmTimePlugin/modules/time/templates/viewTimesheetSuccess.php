...
$holidayService = $formulaire->getHolidayService();
//End Modif
    ...
    <?php else: ?>
        ...
        <div class="box timesheet noHeader" id="timesheet">
            ...
            <div class="inner">
                ...
                <div class="tableWrapper" style="overflow:auto">
                    <table style="width:100%" class="table">
                        <thead>
                            <tr>
                                <th id="projectColumn" style="width:15%"><?php echo __("Project Name") ?></th>
                                <th id ="activityColumn" style="width:15%"><?php echo __("Activity Name") ?></th>
                                <?php foreach ($rowDates as $data): ?>
                                    <?php if ((substr(date('D', strtotime($data)),0,1) == "S") || $holidayService->isHoliday($data)):  ?>
                                        <th class="center weekend" style="width:2%">
                                            <?php echo __(substr(date('D', strtotime($data)),0,1) . "<br>"); ?>
                                ...
                                foreach ($timesheetRows as $timesheetItemRow):
                                    ...
                                    <tr class="<?php echo $class; ?>">
                                        ...
                                        foreach ($timesheetItemRow['timesheetItems'] as $timesheetItemObjects):
                                            if ((substr(date(D,strtotime($timesheetItemObjects->getDate())),0,1) == 'S') || $holidayService->isHoliday($timesheetItemObjects->getDate())) :
                                                if ($format == '1') {
                                                    ?>
                                                    <td class="center comments weekend" style="background-color: #E7E6E6;">
                                                        <?php if ((($timesheetItemObjects->getDuration() == null ) ? "0:00" : $timesheetItemObjects->getConvertTime())>9) :
                                                            echo substr(($timesheetItemObjects->getDuration() == null ) ? "0:00" : $timesheetItemObjects->getConvertTime(),0,2);
                                                        else :
                                                            echo substr(($timesheetItemObjects->getDuration() == null ) ? "0:00" : $timesheetItemObjects->getConvertTime(),0,1);
                                                            endif
                                                ...
                                                <?php } ?>
                                                    ...
                                                    <?php if ($format == '2') { ?>
                                                    <td class="center weekend"><?php echo ($timesheetItemObjects->getDuration() == null ) ? "0.00" : $timesheetItemObjects->getConvertTime();
                                                        ?><span class="commentIcon" data-toggle="modal" href="#commentDialog">
                                                        <?php
                                                        if ($timesheetItemObjects->getComment() != null)
                                                            echo image_tag(theme_path('images/comment.png'), array('id' => 'callout_' .
                                            ...
                                            <?php else :
                                                if ($format == '1') {
                                                    ?>
													<?php
													if (($timesheetItemObjects->getDuration() == null ||  $timesheetItemObjects->getDuration() == "0:00")){
														?>
														<td class="center comments week grayout0">
															<?php if ((($timesheetItemObjects->getDuration() == null) ? "0:00" : $timesheetItemObjects->getConvertTime())>9) :
																echo substr(($timesheetItemObjects->getDuration() == null ) ? "0:00" : $timesheetItemObjects->getConvertTime(),0,2);
															else :
																echo substr(($timesheetItemObjects->getDuration() == null ) ? "0:00" : $timesheetItemObjects->getConvertTime(),0,1);
                                                ...
                                                <?php } ?>
                                                    ...
                                                    <?php if ($format == '2') { ?>
                                                    <td class="center week"><?php echo ($timesheetItemObjects->getDuration() == null ) ? "0.00" : $timesheetItemObjects->getConvertTime();
                                                        ?><span class="commentIcon" data-toggle="modal" href="#commentDialog">
                                                        <?php
                                                        if ($timesheetItemObjects->getComment() != null)
                                                            echo image_tag(theme_path('images/comment.png'), array('id' => 'callout_' .
                                            ...
                                            <?php endif ?>
                                            <?php
                                            $hoursInDay = $timeService->convertDurationToHours($timesheetItemObjects->getDuration())  ;
                                            if($hoursInDay <= 2) 
                                                $totalDays+=0; //0 days if less than 2 hours in a day
                                            else if ($hoursInDay <= 6)
                                                $totalDays+=0.5;   //(half day if less than 6)
                                            else 
                                                $totalDays+=1;     //Full day if more than 6
                                            if ($format == '1')
                                        ...
                                        <?php if ($format == '1') { ?>
                                            <td class="center total" style="background-color: #D9E1F2;">
                                                <strong><?php echo $timeService->convertDurationToHours($total) . '/' . number_format($totalDays, 1, '.', '') . 'd' ; ?></strong>
                                            </td>
                                        <?php $grandTotalDays+=$totalDays;} ?>
                                        <?php if ($format == '2') { ?>
                                            <td class="center total" style="background-color: #D9E1F2;" >
            ...
            ?>
                                ...
                                <tr class="total">
                                    <td id="totalVertical" style="color: black; background-color: #D9E1F2; font-weight: bold;"><?php echo __('Total'); ?></td>
                                    ...
                                    foreach ($rowDates as $data):
                                        ...
                                        endforeach;
                                        ?>
                                        <?php if (substr(date('D', strtotime($data)),0,1) == "S"): ?>
                                            <?php if ($format == '1') { ?>
                                                <?php if ($verticalTotal > 32400) : ?>
                                                    <td class="center weekend" style="background-color: #D9E1F2; font-weight: bold;" ><?php echo substr($timeService->convertDurationToHours($verticalTotal),0,2); ?></td>
                                                <?php elseif ($verticalTotal <> 0) : ?>
                                                    <td class="center weekend" style="background-color: #D9E1F2; font-weight: bold; color: #0094FF;" ><?php echo substr($timeService->convertDurationToHours($verticalTotal),0,1); ?></td>
                                                 <?php else : ?>
                                                    <td class="center weekend" style="background-color: #D9E1F2;" ><?php echo substr($timeService->convertDurationToHours($verticalTotal),0,1); ?></td>
                                                <?php endif ?>
                                            <?php } ?>
                                            <?php if ($format == '2') { ?>
                                                <?php if ($verticalTotal > 32400) : ?>
                                                    <td class="center weekend" style="background-color: #D9E1F2;font-weight: bold;" ><?php echo substr(number_format($verticalTotal, 2, '.', ''),0,2); ?></td>
                                                <?php else : ?>
                                                    <td class="center weekend" style="background-color: #D9E1F2;font-weight: bold;" ><?php echo substr(number_format($verticalTotal, 2, '.', ''),0,1);?></td>
                                                <?php endif ?>
                                            <?php } ?>
                                        <?php else : ?>
                                            <?php if ($format == '1') { ?>
                                                <?php if ($verticalTotal > 32400) : ?>
                                                    <td class="center" style="color: black; background-color: #D9E1F2;font-weight: bold;"><?php echo substr($timeService->convertDurationToHours($verticalTotal),0,2); ?></td>
                                                <?php elseif ($verticalTotal <> 0) : ?>
                                                    <td class="center" style="color: black; background-color: #D9E1F2;font-weight: bold;"><?php echo substr($timeService->convertDurationToHours($verticalTotal),0,1); ?></td>
                                                <?php else : ?>
                                                    <td class="center" style="background-color: #D9E1F2;"><?php echo substr($timeService->convertDurationToHours($verticalTotal),0,1); ?></td>
                                                <?php endif ?>
                                            <?php } ?>
                                            <?php if ($format == '2') { ?>
                                                <?php if ($verticalTotal > 32400) : ?>
                                                    <td class="center" style="color: black; background-color: #D9E1F2;font-weight: bold;"><?php echo substr(number_format($verticalTotal, 2, '.', ''),0,2); ?></td>
                                                <?php else : ?>
                                                    <td class="center" style="color: black; background-color: #D9E1F2;font-weight: bold;"><?php echo substr(number_format($verticalTotal, 2, '.', ''),0,1);?></td>
                                                <?php endif ?>
                                            <?php } ?>
                                        <?php endif ?>
                <?php
            ...
            ?>
                                    <?php if ($format == '1') { ?>
                                        <td class="center total" style="background-color: #D9E1F2;">
                                            <strong><?php echo $timeService->convertDurationToHours($weeksTotal) . '/' . number_format($grandTotalDays, 1, '.', '') . 'd' ; ?></strong>
                                        </td>
                                    <?php } ?>
                                <?php if ($format == '2') { ?>
                                        <td class="center total">
                                            <strong><?php echo number_format($weeksTotal, 2, '.', '')  . '/' . number_format($grandTotalDays, 1, '.', '') . 'd' ; ?></strong>
                                        </td>
            <?php } ?>
                                </tr>
        <?php endif; ?>
        ...
        <?php echo $createTimesheetForm['_csrf_token']; ?>
                    <fieldset>
                        <ol>
                            ...
                            <?php // Marc 7/14/2016 Modif ?>
                            <li>
                                <?php //echo $youhou ?>
                                <?php echo $createTimesheetForm['previous']->renderLabel(__('Duplicate previous Timesheet')); ?>
                                <?php echo $createTimesheetForm['previous']->render(); ?>
                                <?php echo $createTimesheetForm['previous']->renderError() ?>
                            </li>
                            <?php // Marc 7/14/2016 ?>
                        </ol>
                    </fieldset>
