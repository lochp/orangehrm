...
class saveTimesheetAction extends sfAction {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($request->getParameter('btnRemoveRows')) {
                if ($this->numberOfRows == null) {
                    ...
                    $this->getTimesheetService()->deleteTimesheetItems($this->employeeId, $this->timesheetId, $request->getParameter('initialRows'));
    ...
    public function getTimesheetService() {
        if (!($this->timesheetService instanceof TimesheetService)) {
