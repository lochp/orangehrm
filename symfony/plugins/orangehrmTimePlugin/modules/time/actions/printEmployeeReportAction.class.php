 ...
 */
class printEmployeeReportCriteriaAction extends displayReportCriteriaAction {

    public function execute($request) {

        $hasRight = false;
        
        $this->employeeReportsPermissions = $this->getDataGroupPermissions('time_print_employee_timesheet');
    ...
    public function getDataGroups() {
        return array('time_print_employee_timesheet');
    }
