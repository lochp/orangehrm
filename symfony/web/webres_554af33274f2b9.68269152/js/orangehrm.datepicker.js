    ...
    var markDates = function(date){
        ...
        for (i = 0; i < holidayList.length; i++) {
            ...
            if (date.getMonth() == holidayList[i][1] - 1
            	...
            	&& (HolidayObject == undefined || HolidayObject.coucodeOfEmpl == null || HolidayObject.coucodeOfEmpl == ''
            			|| (HolidayObject != undefined && HolidayObject.coucodeOfEmpl != null && HolidayObject.coucodeOfEmpl == holidayList[i][5])) // Loc add country condition
            	) {
