$(document).ready(function(){
    ...
    //Marc 7/14/2016 Modif
    //Duplicate previous timesheet
    //Permit Timesheets over the present date
    $("#addTimesheetBtn").click(function() {
        var startdate=$("#time_date").val();
        var isduplicate=$("#previous").is(':checked'); //marc xxxx  added
                ...
                $.getJSON(url, function(data) {
                    ...
                    if(data[0]==2){
                        ...
                        $('form#createTimesheetForm').attr({
                            action:linkForViewTimesheet+"?&timesheetStartDateFromDropDown="+startDate[0]+"&employeeId="+employeeId+"&isduplicate="+isduplicate
                        });
