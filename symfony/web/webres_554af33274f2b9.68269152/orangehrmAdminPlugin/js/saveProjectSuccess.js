...
function disableWidgets(){
    ...
    $('.formInputCustomerMail').attr('disabled','disabled'); //Marc Modif report mail for customer
...
function enableWidgets(){
    ...
    $('.formInputCustomerMail').removeAttr('disabled'); //Marc Modif report mail for customer
